...
URL_GE: str = "https://www.formula1.com/en/latest"
...
REGEX_SUBSTRING: re.Pattern[str] = re.compile(r"norris", re.IGNORECASE)

# \b = limite de palavra — evita casar pedaços estranhos em palavras longas.
REGEX_PALAVRA: re.Pattern[str] = re.compile(r"\bnorris\b", re.IGNORECASE)
